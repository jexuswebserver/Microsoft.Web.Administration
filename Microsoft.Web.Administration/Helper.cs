...
namespace Microsoft.Web.Administration
{
    internal static class Helper
    {
        ...
        internal static string ExpandIisExpressEnvironmentVariables(this string path)
        {
        ...
        internal static bool IsRoot(this Application application)
        {
            return application.Path == Application.RootPath;
        }
